...
class CustomAuthToken(ObtainAuthToken):
    ...
    def _get_tenant_info(self, user, request) -> dict:
        ...
        try:
            ...
            # Superadmins should default to PUBLIC unless they explicitly
            # provide a tenant header (to avoid leaking tenant data by default).
            ...
            # Superadmin without explicit tenant header -> stay in public schema
            if is_superadmin:
                return {
                    'schema_name': 'public',
                    'tenant_id':   None,
