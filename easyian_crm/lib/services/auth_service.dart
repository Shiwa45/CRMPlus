...
class AuthService {
  ...
  Future<UserModel> login(String username, String password) async {
    ...
    final tenantLogo = (data['tenant_logo'] ?? '').toString();
    ...
    if (tenantLogo.isNotEmpty) await prefs.setString(AppConstants.tenantLogoKey, tenantLogo);
  ...
  Future<void> logout() async {
    ...
    await prefs.remove(AppConstants.tenantLogoKey);
