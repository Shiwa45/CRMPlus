...
class PipelineModel {
  ...
  PipelineModel({required this.id, required this.name, required this.isDefault,
...
class QuoteItemModel {
  ...
  factory QuoteItemModel.fromJson(Map<String, dynamic> j) => QuoteItemModel(
    id: _toInt(j['id']), gstRate: _toInt(j['gst_rate']), order: _toInt(j['order']),
    name: j['name'] ?? '', unit: j['unit'] ?? 'nos',
    description: j['description'], hsnSacCode: j['hsn_sac_code'],
...
class QuoteModel {
  ...
  factory QuoteModel.fromJson(Map<String, dynamic> j) => QuoteModel(
    ...
    currency: j['currency'] ?? 'INR', quoteDate: j['quote_date'] ?? '',
    createdAt: j['created_at'] ?? '',
    contactName: j['contact_name'], companyName: j['company_name'],
    ...
    taxableAmount: _toDouble(j['taxable_amount']),
...
class PaymentModel {
  ...
  factory PaymentModel.fromJson(Map<String, dynamic> j) => PaymentModel(
    ...
    notes: j['notes'], recordedByName: j['recorded_by_name'],
  );
}
...
class InvoiceModel {
  ...
  InvoiceModel({required this.id, required this.invoiceNumber, required this.status,
    ...
    required this.isEinvoice, required this.payments});
  ...
  factory InvoiceModel.fromJson(Map<String, dynamic> j) => InvoiceModel(
    ...
    invoiceDate: j['invoice_date'] ?? '', createdAt: j['created_at'] ?? '',
    contactName: j['contact_name'], companyName: j['company_name'],
...
class TicketModel {
  ...
  factory TicketModel.fromJson(Map<String, dynamic> j) => TicketModel(
    id: _toInt(j['id']), ticketNumber: j['ticket_number'] ?? '',
    subject: j['subject'] ?? '', status: j['status'] ?? 'open',
    priority: j['priority'] ?? 'medium', channel: j['channel'] ?? 'manual',
    createdAt: j['created_at'] ?? '',
    contactName: j['contact_name'], companyName: j['company_name'],
