        ...
        Container(
          ...
          child: Column(children: [
            ...
            Row(children: [
              ...
              const SizedBox(width: 12),
              _typeToggle('Public', !_isInternal, Colors.blue, () => setState(() => _isInternal = false)),
              const SizedBox(width: 8),
              _typeToggle('Internal Note', _isInternal, Colors.orange, () => setState(() => _isInternal = true)),
            ]),
            const SizedBox(height: 10),
            Row(children: [
              Expanded(child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: _isInternal ? 'Internal note (not visible to customer)...' : 'Reply to customer...',
                  hintStyle: GoogleFonts.inter(fontSize: 13, color: Colors.grey),
                  filled: true,
                  fillColor: _isInternal
                      ? Colors.orange.withOpacity(0.05)
                      : (isDark ? AppColors.darkBg : Colors.grey.shade50),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12),
                      borderSide: BorderSide(color: _isInternal ? Colors.orange.shade200 : Colors.grey.shade200)),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12),
                      borderSide: BorderSide(color: _isInternal ? Colors.orange.shade300 : Colors.grey.shade200)),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _isInternal ? Colors.orange : Colors.blue.shade700,
                ...
                child: _sendingReply
                    ...
                    : Icon(_isInternal ? Icons.lock_outline : Icons.send, size: 18),
              ),
            ]),
          ]),
        ),
...
class _ReplyBubble extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isInternal = reply.isInternal;
    final bubbleColor = isInternal
        ? Colors.orange.withOpacity(0.1)
        : (isDark ? AppColors.darkCard : Colors.white);
    final borderColor = isInternal ? Colors.orange.withOpacity(0.4) : Colors.transparent;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [if (!isInternal) BoxShadow(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          CircleAvatar(
            ...
            child: Text((reply.authorName.isNotEmpty ? reply.authorName[0] : '?').toUpperCase(),
                style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w700,
                    color: AppColors.primary)),
          ),
          const SizedBox(width: 10),
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(reply.authorName, style: GoogleFonts.inter(
