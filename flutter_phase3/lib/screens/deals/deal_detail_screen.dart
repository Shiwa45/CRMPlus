      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          _valCard('Expected Close',
              d.expectedCloseDate != null ? _fmtDate(d.expectedCloseDate!) : '—',
              Colors.orange, isDark),
        ]),
        const SizedBox(height: 16),
        _infoCard('Deal Info', [
          _row(Icons.pipeline, 'Pipeline', d.pipelineName ?? '—'),
          ...
          if (d.expectedCloseDate != null) _row(Icons.event, 'Expected Close', _fmtDate(d.expectedCloseDate!)),
        ], isDark),
