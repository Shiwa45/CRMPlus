        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          TabBar(
            ...
            tabs: const [
              ...
              Tab(icon: Icon(Icons.whatsapp, size: 16), text: 'WhatsApp'),
...
class _IntegrationsTabState extends State<_IntegrationsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final services = [
      {'service': 'whatsapp', 'icon': Icons.whatsapp, 'color': const Color(0xFF25D366),
...
class _IntegrationCardState extends State<_IntegrationCard> {
  ...
  @override
  void dispose() {
    _keyCtrl.dispose(); _secretCtrl.dispose(); _extraCtrl.dispose();
    super.dispose();
  }
  ...
  Future<void> _save() async {
    ...
    try {
      final body = {
        ...
        if (_secretCtrl.text.isNotEmpty) 'api_secret': _secretCtrl.text,
        'is_enabled': true,
      };
      if (widget.existing != null) {
...
class _WhatsAppTabState extends State<_WhatsAppTab> {
  ...
  Widget _empty() => Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
    const Icon(Icons.whatsapp, size: 52, color: Color(0xFF25D366)),
        ...
        Wrap(spacing: 6, children: [
          for (final v in List.from(template['variables'] ?? []))
            Container(
              ...
              child: Text('{{$v}}',
                  style: GoogleFonts.inter(fontSize: 11, color: const Color(0xFF25D366),
